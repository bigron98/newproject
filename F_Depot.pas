...
begin
  ...
  begin
    ...
    try
      ...
      Spr_SupplierSupplier_Name.Value:='Новый поставщик';
...
begin
    if MessageDlg('Подтвердите удаление записи?',mtConfirmation, [mbYes, mbNo], 0) = mrNo then Abort;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      if (ID_Parent=0) then
      begin
        Spr_ItemsItems_Name.Value:='Новая папка';
        Spr_ItemsItems_Articul.Value:='';
        Spr_ItemsItems_Level.Value:=0;
      end
      else
      begin
        Spr_ItemsItems_Name.Value:='Новый товар';
...
begin
  ...
  begin
    ...
    try
      ...
      Spr_EdizmEdizm_Name.Value:='Новая единица измерения';
      Spr_KeyID_Key.Value := Spr_KeyID_Key.Value + 1;
      Post;
    finally
      Close;
...
begin
  ...
  begin
    ...
    try
      ...
      Spr_ConfigItems_Name.Value:='Новая конфигурация';
...
begin
  ...
  begin
    ...
    try
      ...
      ArrivalArrival_Name.Value:='Новый приход';
...
begin
  ...
  begin
    ...
    try
      ...
      ChargeCharge_Name.Value:='Новый расход';
      ChargeCharge_Date.Value:=Date();
      ChargeZakaz_Name.Value:='Заказчик';
...
begin
  ...
  if VarIsNull(Ostatki.Lookup('ID_Items',Charge_ItemsID_Items.Value,'Total_Ost')) then
    ...
    begin
      ShowMessage('Превышает кол-во в наличии.');
      Abort;
    end
  end
  else
